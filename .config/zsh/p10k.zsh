# Generated by Powerlevel10k configuration wizard on 2025-03-03 at 00:34 EST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 06405.
# Wizard options: compatible, unicode, lean_8colors, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    chruby                  # ruby version from chruby (https://github.com/postmodern/chruby)
